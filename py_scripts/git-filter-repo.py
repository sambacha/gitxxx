...
"""
master: https://github.com/newren/git-filter-repo/blob/d2fdc89ff3adcede647d9358d35a336a30bc206e/git-filter-repo
release: v2.29.0
SPDX-License-Identifier: MIT
license: https://raw.githubusercontent.com/newren/git-filter-repo/main/COPYING.mit
...
class GitUtils(object):
    ...
    def print_my_version():
        ...
        contents = re.sub(br"\A#\!.*", br"#!/usr/bin/env python3", contents)
        contents = re.sub(
...
class RepoFilter(object):
    ...
    def _tweak_blob(self, blob):
        ...
        if self._args.replace_text and not any(x == b"0" for x in blob.data[0:8192]):
